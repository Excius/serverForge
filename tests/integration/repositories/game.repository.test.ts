...
describe("GameRepository", () => {
  ...
  describe("findById", () => {
    ...
    it("should return null if game is soft deleted", async () => {
  ...
  describe("findBySlug", () => {
    ...
    it("should return empty if game is soft deleted", async () => {
